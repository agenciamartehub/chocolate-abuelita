//@prepros-prepend ../jquery/jquery-3.1.1.min.js
//@prepros-prepend ../wpkitui2/wpkitui.js
//@prepros-prepend ../fancybox/jquery.fancybox.min.js
...
jQuery(document).ready(function($){
	...
	// Se hizo una optimización para varios scripts, el autoplay
	// se sobreescribe en el bloque // optimize CSS delivery $('.slider').slick('slickPlay')
	$('.slider').slick({
		infinite: true,
		slidesToShow: 1,
		slidesToScroll: 1,
