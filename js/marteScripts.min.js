!function(e, t) {
    ...
    function f(e, t, n) {
        var i;
        if (void 0 === n && 1 === e.nodeType) if (i = "data-" + t.replace(Ie, "-$&").toLowerCase(), 
    ...
    function h(e, t, n, i) {
        var o, s = 1, r = 20, a = i ? function() {
            ...
            return fe.css(e, t, "");
        }, l = a(), c = n && n[3] || (fe.cssNumber[t] ? "" : "px"), d = (fe.cssNumber[t] || "px" !== c && +l) && He.exec(fe.css(e, t));
        if (d && d[3] !== c) {
            c = c || d[3], n = n || [], d = +l || 1;
            do {
    ...
    function b(e, t, n, i, o) {
        for (var s, r, a, l, c, d, u = t.createDocumentFragment(), p = [], f = 0, h = e.length; f < h; f++) if ((s = e[f]) || 0 === s) if ("object" === fe.type(s)) fe.merge(p, s.nodeType ? [ s ] : s); else if (Ue.test(s)) {
            for (r = r || u.appendChild(t.createElement("div")), a = (_e.exec(s) || [ "", "" ])[1].toLowerCase(), 
        ...
        r = v(u.appendChild(s), "script"), c && y(r), n) for (d = 0; s = r[d++]; ) Xe.test(s.type || "") && n.push(s);
        return u;
    }
    function x() {
        return !0;
    ...
    function S(e, t, n, i, o, s) {
        ...
        i = void 0) : (o = i, i = n, n = void 0)), !1 === o) o = w; else if (!o) return e;
    ...
    function A(e, t, i, o) {
        ...
        r || o)) {
            ...
            Xe.test(c.type || "") && !Oe.access(c, "globalEval") && fe.contains(d, c) && (c.src ? fe._evalUrl && fe._evalUrl(c.src) : n(c.textContent.replace(nt, ""), d));
        }
        return e;
    }
    function L(e, t, n) {
    ...
    function H() {
        pt && (e.requestAnimationFrame(H), fe.fx.tick());
    }
    function q() {
    ...
    function U(e) {
        return function(t, n) {
            ...
            var i, o = 0, s = t.toLowerCase().match(Pe) || [];
    ...
    var ye = function(e) {
        function t(e, t, n, i) {
            ...
            if (!i && ((t ? t.ownerDocument || t : q) !== j && L(t), t = t || j, O)) {
                if (11 !== h && (l = ge.exec(e))) if (o = l[1]) {
                    ...
                    } else if (f && (r = f.getElementById(o)) && F(t, r) && r.id === o) return n.push(r), 
                    n;
                } else {
                    if (l[2]) return Q.apply(n, t.getElementsByTagName(e)), n;
                    if ((o = l[3]) && x.getElementsByClassName && t.getElementsByClassName) return Q.apply(n, t.getElementsByClassName(o)), 
                    n;
                }
                if (x.qsa && !_[e + " "] && (!N || !N.test(e))) {
        ...
        function p(e, t, n) {
            ...
            return t.first ? function(t, n, o) {
                ...
                } else for (;t = t[i]; ) if (1 === t.nodeType || r) if (u = t[H] || (t[H] = {}), 
        ...
        function v(e) {
            for (var t, n, i, o = e.length, s = w.relative[e[0].type], r = s || w.relative[" "], a = s ? 1 : 0, l = p(function(e) {
                return e === t;
            }, r, !0), c = p(function(e) {
                return J(t, e) > -1;
                ...
                return t = null, o;
            } ]; a < o; a++) if (n = w.relative[e[a].type]) d = [ p(f(d), n) ]; else {
        ...
        function y(e, n) {
            var o = n.length > 0, s = e.length > 0, r = function(i, r, a, l, c) {
                var d, u, p, f = 0, h = "0", m = i && [], v = [], y = E, b = i || s && w.find.TAG("*", c), x = z += null == y ? 1 : Math.random() || .1, T = b.length;
                for (c && (E = r === j || r || c); h !== T && null != (d = b[h]); h++) {
                    if (s && d) {
        ...
        var b, x, w, T, S, k, C, $, E, P, A, L, j, D, O, N, M, I, F, H = "sizzle" + 1 * new Date(), q = e.document, z = 0, R = 0, W = n(), B = n(), _ = n(), X = function(e, t) {
            return e === t && (A = !0), 0;
        ...
        x = t.support = {}, S = t.isXML = function(e) {
            ...
            O = !S(j), q !== j && (n = j.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", we, !1) : n.attachEvent && n.attachEvent("onunload", we)), 
            x.attributes = o(function(e) {
                return e.className = "i", !e.getAttribute("className");
            }), x.getElementsByTagName = o(function(e) {
                return e.appendChild(j.createComment("")), !e.getElementsByTagName("*").length;
            }), x.getElementsByClassName = he.test(j.getElementsByClassName), x.getById = o(function(e) {
                return D.appendChild(e).id = H, !j.getElementsByName || !j.getElementsByName(H).length;
            ...
            }, M = [], N = [], (x.qsa = he.test(j.querySelectorAll)) && (o(function(e) {
                ...
                e.querySelectorAll("[id~=" + H + "-]").length || N.push("~="), e.querySelectorAll(":checked").length || N.push(":checked"), 
                ...
                x.disconnectedMatch = I.call(e, "*"), I.call(e, "[s!='']:x"), M.push("!=", ie);
            }), N = N.length && new RegExp(N.join("|")), M = M.length && new RegExp(M.join("|")), 
            t = he.test(D.compareDocumentPosition), F = t || he.test(D.contains) ? function(e, t) {
                ...
                return n || (1 & (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1) || !x.sortDetached && t.compareDocumentPosition(e) === n ? e === j || e.ownerDocument === q && F(q, e) ? -1 : t === j || t.ownerDocument === q && F(q, t) ? 1 : P ? J(P, e) - J(P, t) : 0 : 4 & n ? -1 : 1);
            } : function(e, t) {
                if (e === t) return A = !0, 0;
                var n, i = 0, o = e.parentNode, s = t.parentNode, a = [ e ], l = [ t ];
                if (!o || !s) return e === j ? -1 : t === j ? 1 : o ? -1 : s ? 1 : P ? J(P, e) - J(P, t) : 0;
                if (o === s) return r(e, t);
            ...
            if ((e.ownerDocument || e) !== j && L(e), n = n.replace(le, "='$1']"), x.matchesSelector && O && !_[n + " "] && (!M || !M.test(n)) && (!N || !N.test(n))) try {
                var i = I.call(e, n);
            ...
            var n = w.attrHandle[t.toLowerCase()], i = n && Y.call(w.attrHandle, t.toLowerCase()) ? n(e, t, !O) : void 0;
            ...
            var t, n = [], i = 0, o = 0;
            if (A = !x.detectDuplicates, P = !x.sortStable && e.slice(0), e.sort(X), A) {
            ...
            filter: {
                    ...
                    return 1 === i && 0 === o ? function(e) {
                        ...
                        if (m) {
                            ...
                            if (h = [ r ? m.firstChild : m.lastChild ], r && y) {
                                for (b = (f = (c = (d = (u = (p = m)[H] || (p[H] = {}))[p.uniqueID] || (u[p.uniqueID] = {}))[e] || [])[0] === z && c[1]) && c[2], 
                                p = f && m.childNodes[f]; p = ++f && p && p[g] || (b = f = 0) || h.pop(); ) if (1 === p.nodeType && ++b && p === t) {
                                    d[e] = [ z, f, b ];
                                    break;
                                }
                            } else if (y && (p = t, u = p[H] || (p[H] = {}), d = u[p.uniqueID] || (u[p.uniqueID] = {}), 
                            c = d[e] || [], f = c[0] === z && c[1], b = f), !1 === b) for (;(p = ++f && p && p[g] || (b = f = 0) || h.pop()) && ((a ? p.nodeName.toLowerCase() !== v : 1 !== p.nodeType) || !++b || (y && (u = p[H] || (p[H] = {}), 
                ...
                PSEUDO: function(e, n) {
                    ...
                    return s[H] ? s(n) : s.length > 1 ? (o = [ e, e, "", n ], w.setFilters.hasOwnProperty(e.toLowerCase()) ? i(function(e, t) {
        ...
        return d.prototype = w.filters = w.pseudos, w.setFilters = new d(), k = t.tokenize = function(e, n) {
            ...
            for (a = e, l = [], c = w.preFilter; a; ) {
                ...
                for (r in w.filter) !(o = ue[r].exec(a)) || c[r] && !(o = c[r](o)) || (i = o.shift(), 
                s.push({
                    value: i,
                    type: r,
                    matches: o
            ...
            var n, i = [], o = [], s = _[e + " "];
            if (!s) {
                for (t || (t = k(e)), n = t.length; n--; ) (s = v(t[n]))[H] ? i.push(s) : o.push(s);
                (s = _(e, y(o, i))).selector = e;
            }
            return s;
        }, $ = t.select = function(e, t, n, i) {
            var o, s, r, a, l, d = "function" == typeof e && e, p = !i && k(e = d.selector || e);
            if (n = n || [], 1 === p.length) {
                if ((s = p[0] = p[0].slice(0)).length > 2 && "ID" === (r = s[0]).type && 9 === t.nodeType && O && w.relative[s[1].type]) {
                    if (!(t = (w.find.ID(r.matches[0].replace(ve, ye), t) || [])[0])) return n;
                    d && (t = t.parentNode), e = e.slice(s.shift().value.length);
                }
                for (o = ue.needsContext.test(e) ? 0 : s.length; o-- && (r = s[o], !w.relative[a = r.type]); ) if ((l = w.find[a]) && (i = l(r.matches[0].replace(ve, ye), me.test(s[0].type) && c(t.parentNode) || t))) {
    ...
    var be = function(e, t, n) {
        ...
        return n;
    }, we = fe.expr.match.needsContext, Te = /^<([a-z][^\/\0>:\x20\t\r\n\f]*)[\x20\t\r\n\f]*\/?>(?:<\/\1>|)$/i, Se = /^.[^:#\[\.,]*$/;
    ...
    var $e = /^(?:parents|prev(?:Until|All))/, Ee = {
        children: !0,
        contents: !0,
        next: !0,
        prev: !0
    ...
    fe.fn.extend({
        ...
        closest: function(e, t) {
            ...
            if (!we.test(e)) for (;i < o; i++) for (n = this[i]; n && n !== t; n = n.parentNode) if (n.nodeType < 11 && (r ? r.index(n) > -1 : 1 === n.nodeType && fe.find.matchesSelector(n, e))) {
                s.push(n);
                break;
            }
        ...
        fe.fn[e] = function(n, i) {
            ...
            this.length > 1 && (Ee[e] || fe.uniqueSort(o), $e.test(e) && o.reverse()), this.pushStack(o);
        };
    });
    var Pe = /[^\x20\t\r\n\f]+/g;
    ...
    u.uid = 1, u.prototype = {
        ...
        remove: function(e, t) {
            ...
            if (void 0 !== i) {
                if (void 0 !== t) {
                    fe.isArray(t) ? t = t.map(fe.camelCase) : (t = fe.camelCase(t), t = t in i ? [ t ] : t.match(Pe) || []), 
                    n = t.length;
                    for (;n--; ) delete i[t[n]];
                }
    ...
    var Oe = new u(), Ne = new u(), Me = /^(?:\{[\w\W]*\}|\[[\w\W]*\])$/, Ie = /[A-Z]/g;
    fe.extend({
        hasData: function(e) {
    ...
    var Fe = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source, He = new RegExp("^(?:([+-])=|)(" + Fe + ")([a-z%]*)$", "i"), qe = [ "Top", "Right", "Bottom", "Left" ], ze = function(e, t) {
    ...
    var Be = /^(?:checkbox|radio)$/i, _e = /<([a-z][^\/\0>\x20\t\r\n\f]+)/i, Xe = /^$|\/(?:java|ecma)script/i, Ye = {
    ...
    fe.event = {
        ...
        add: function(e, t, n, i, o) {
            ...
            }), c = (t = (t || "").match(Pe) || [ "" ]).length; c--; ) a = Ze.exec(t[c]) || [], 
        ...
        remove: function(e, t, n, i, o) {
            ...
            if (m && (l = m.events)) {
                for (c = (t = (t || "").match(Pe) || [ "" ]).length; c--; ) if (a = Ze.exec(t[c]) || [], 
    ...
    fe.extend({
        ...
        clone: function(e, t, n) {
            ...
            s = v(e), i = 0, o = s.length; i < o; i++) P(s[i], r[i]);
        ...
        html: function(e) {
            return je(this, function(e) {
                ...
                if ("string" == typeof e && !Ke.test(e) && !Ye[(_e.exec(e) || [ "", "" ])[1].toLowerCase()]) {
    ...
    var it = /^margin/, ot = new RegExp("^(" + Fe + ")(?!px)[a-z%]+$", "i"), st = function(t) {
    ...
    fe.extend({
        ...
        style: function(e, t, n, i) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                ...
                void 0 === n ? r && "get" in r && void 0 !== (o = r.get(e, !1, i)) ? o : l[t] : ("string" === (s = typeof n) && (o = He.exec(n)) && o[1] && (n = h(e, t, o), 
        ...
        fe.cssHooks[t] = {
            get: function(e, n, i) {
                if (n) return !rt.test(fe.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? I(e, t, i) : Re(e, at, function() {
                    return I(e, t, i);
                });
            },
            set: function(e, n, i) {
                var o, s = i && st(e), r = i && M(e, t, i, "border-box" === fe.css(e, "boxSizing", !1, s), s);
                return r && (o = He.exec(n)) && "px" !== (o[3] || "px") && (e.style[t] = n, n = fe.css(e, t)), 
                N(0, n, r);
            }
        };
    ...
    fe.Animation = fe.extend(B, {
        ...
        pt || (pt = e.requestAnimationFrame ? e.requestAnimationFrame(H) : e.setInterval(fe.fx.tick, fe.fx.interval));
    }, fe.fx.stop = function() {
    ...
    fe.fn.extend({
        ...
        addClass: function(e) {
            ...
            if ("string" == typeof e && e) for (t = e.match(Pe) || []; n = this[l++]; ) if (o = X(n), 
            i = 1 === n.nodeType && " " + _(o) + " ") {
                for (r = 0; s = t[r++]; ) i.indexOf(" " + s + " ") < 0 && (i += s + " ");
                o !== (a = _(i)) && n.setAttribute("class", a);
            }
            return this;
        },
        ...
        toggleClass: function(e, t) {
            ...
            return "boolean" == typeof t && "string" === n ? t ? this.addClass(e) : this.removeClass(e) : fe.isFunction(e) ? this.each(function(n) {
                ...
                var t, i, o, s;
                if ("string" === n) for (i = 0, o = fe(this), s = e.match(Pe) || []; t = s[i++]; ) o.hasClass(t) ? o.removeClass(t) : o.addClass(t); else void 0 !== e && "boolean" !== n || ((t = X(this)) && Oe.set(this, "__className__", t), 
                this.setAttribute && this.setAttribute("class", t || !1 === e ? "" : Oe.get(this, "__className__") || ""));
            });
        },
        hasClass: function(e) {
            var t, n, i = 0;
            for (t = " " + e + " "; n = this[i++]; ) if (1 === n.nodeType && (" " + _(X(n)) + " ").indexOf(t) > -1) return !0;
            return !1;
        }
    });
    var bt = /\r/g;
    ...
    fe.extend(fe.event, {
        trigger: function(t, n, i, o) {
            ...
            if (r = a = i = i || ee, 3 !== i.nodeType && 8 !== i.nodeType && !xt.test(f + fe.event.triggered) && (f.indexOf(".") > -1 && (h = f.split("."), 
            ...
            u = fe.event.special[f] || {}, o || !u.trigger || !1 !== u.trigger.apply(i, n))) {
                if (!o && !u.noBubble && !fe.isWindow(i)) {
                    for (l = u.delegateType || f, xt.test(l + f) || (r = r.parentNode); r; r = r.parentNode) p.push(r), 
                    a = r;
    ...
    var wt = e.location, Tt = fe.now(), St = /\?/;
    ...
    var kt = /\[\]$/, Ct = /\r?\n/g, $t = /^(?:submit|button|image|reset|file)$/i, Et = /^(?:input|select|textarea|keygen)/i;
    fe.param = function(e, t) {
        ...
        serializeArray: function() {
            return this.map(function() {
                ...
                var e = this.type;
                return this.name && !fe(this).is(":disabled") && Et.test(this.nodeName) && !$t.test(e) && (this.checked || !Be.test(e));
            }).map(function(e, t) {
                var n = fe(this).val();
    ...
    var Pt = /%20/g, At = /#.*$/, Lt = /([?&])_=[^&]*/, jt = /^(.*?):[ \t]*([^\r\n]*)$/gm, Dt = /^(?:about|app|app-storage|.+-extension|file|res|widget):$/, Ot = /^(?:GET|HEAD)$/, Nt = /^\/\//, Mt = {}, It = {}, Ft = "*/".concat("*"), Ht = ee.createElement("a");
    Ht.href = wt.href, fe.extend({
        active: 0,
        lastModified: {},
        etag: {},
        ajaxSettings: {
        ...
        ajax: function(t, n) {
            function i(t, n, i, a) {
                ...
                c = t >= 200 && t < 300 || 304 === t, i && (x = Q(h, S, i)), x = Z(h, x, S, c), 
                c ? (h.ifModified && ((w = S.getResponseHeader("Last-Modified")) && (fe.lastModified[s] = w), 
                (w = S.getResponseHeader("etag")) && (fe.etag[s] = w)), 204 === t || "HEAD" === h.type ? T = "nocontent" : 304 === t ? T = "notmodified" : (T = x.state, 
                p = x.data, f = x.error, c = !f)) : (f = T, !t && T || (T = "error", t < 0 && (t = 0))), 
            ...
            var o, s, r, a, l, c, d, u, p, f, h = fe.ajaxSetup({}, n), g = h.context || h, m = h.context && (g.nodeType || g.jquery) ? fe(g) : fe.event, v = fe.Deferred(), y = fe.Callbacks("once memory"), b = h.statusCode || {}, x = {}, w = {}, T = "canceled", S = {
                readyState: 0,
                ...
                setRequestHeader: function(e, t) {
                    return null == d && (e = w[e.toLowerCase()] = w[e.toLowerCase()] || e, x[e] = t), 
                    this;
                },
            ...
            if (v.promise(S), h.url = ((t || h.url || wt.href) + "").replace(Nt, wt.protocol + "//"), 
            h.type = n.method || n.type || h.method || h.type, h.dataTypes = (h.dataType || "*").toLowerCase().match(Pe) || [ "" ], 
            null == h.crossDomain) {
            ...
            h.hasContent ? h.data && h.processData && 0 === (h.contentType || "").indexOf("application/x-www-form-urlencoded") && (h.data = h.data.replace(Pt, "+")) : (f = h.url.slice(s.length), 
            ...
            if (T = "abort", y.add(h.complete), S.done(h.success), S.fail(h.error), o = V(It, h, n, S)) {
    ...
    fe.ajaxSetup({
        ...
        return a > -1 && (i = _(e.slice(a)), e = e.slice(0, a)), fe.isFunction(t) ? (n = t, 
    ...
    var Bt = e.jQuery, _t = e.$;
    return fe.noConflict = function(t) {
        return e.$ === fe && (e.$ = _t), t && e.jQuery === fe && (e.jQuery = Bt), fe;
    }, t || (e.jQuery = e.$ = fe), fe;
}), function(e) {
    var t;
    ...
    !function(e, t, n) {
        ...
        function p(e, n, i, s) {
            ...
            p.id = d, f.fake && (f.style.background = "", f.style.overflow = "hidden", c = w.style.overflow, 
            w.style.overflow = "hidden", w.appendChild(f)), a = n(p, e), f.fake ? (f.parentNode.removeChild(f), 
            w.style.overflow = c, w.offsetHeight) : p.parentNode.removeChild(p), !!a;
        }
        function f(t, i) {
            var o = t.length;
        ...
        function g(e, t, n, o, s) {
            var r = e.charAt(0).toUpperCase() + e.slice(1), a = (e + " " + E.join(r + " ") + r).split(" ");
            return i(t, "string") || i(t, "undefined") ? h(a, t, o, s) : (a = (e + " " + P.join(r + " ") + r).split(" "), 
            l(a, t, n));
        }
        function m(e, t, i) {
            return g(e, n, n, t, i);
        ...
        var w = t.documentElement, T = "svg" === w.nodeName.toLowerCase(), S = b._config.usePrefixes ? " -webkit- -moz- -o- -ms- ".split(" ") : [ "", "" ];
        b._prefixes = S, x.addTest("cssgradients", function() {
            for (var e, t = "background-image:", n = "", i = 0, s = S.length - 1; s > i; i++) e = 0 === i ? "to " : "", 
            n += t + S[i] + "linear-gradient(" + e + "left top, #9f9, white);";
            x._config.usePrefixes && (n += t + "-webkit-gradient(linear,left top,right bottom,from(#9f9),to(white));");
            var r = o("a").style;
            return r.cssText = n, ("" + r.backgroundImage).indexOf("gradient") > -1;
        });
        var k = "CSS" in e && "supports" in e.CSS, C = "supportsCSS" in e;
        x.addTest("supports", k || C);
        var $ = "Moz O ms Webkit", E = b._config.usePrefixes ? $.split(" ") : [];
        b._cssomPrefixes = E;
        ...
        x._q.unshift(function() {
            delete L.style;
        }), b.testAllProps = g, b.testAllProps = m, x.addTest("cssfilters", function() {
            if (x.supports) return m("filter", "blur(2px)");
            var e = o("a");
            return e.style.cssText = S.join("filter:blur(2px); "), !!e.style.length && (t.documentMode === n || t.documentMode > 9);
        }), x.addTest("flexbox", m("flexBasis", "1px", !0)), function() {
            var e, t, n, o, s, r, a;
            for (var l in y) if (y.hasOwnProperty(l)) {
                ...
                1 === (a = r.split(".")).length ? x[a[0]] = o : (!x[a[0]] || x[a[0]] instanceof Boolean || (x[a[0]] = new Boolean(x[a[0]])), 
                x[a[0]][a[1]] = o), v.push((o ? "" : "no-") + a.join("-"));
            }
        }(), function(e) {
            ...
            x._config.enableClasses && (t += " " + n + e.join(" " + n), T ? w.className.baseVal = t : w.className = t);
    ...
    }), lightbox_0 = new fusepump.lightbox.buynow(20282), document.getElementById("lightbox-call-to-action-0").addEventListener("click", function() {
        lightbox_0.show();
    }), lightbox_20 = new fusepump.lightbox.buynow(20282), document.getElementById("lightbox-call-to-action-20").addEventListener("click", function() {
        lightbox_20.show();
    }), lightbox_10 = new fusepump.lightbox.buynow(20184), document.getElementById("lightbox-call-to-action-10").addEventListener("click", function() {
        lightbox_10.show();
    }), lightbox_1 = new fusepump.lightbox.buynow(19452), document.getElementById("lightbox-call-to-action-1").addEventListener("click", function() {
        lightbox_1.show();
    }), lightbox_2 = new fusepump.lightbox.buynow(20183), document.getElementById("lightbox-call-to-action-2").addEventListener("click", function() {
        lightbox_2.show();
    }), lightbox_3 = new fusepump.lightbox.buynow(19453), document.getElementById("lightbox-call-to-action-3").addEventListener("click", function() {
        lightbox_3.show();
    }), lightbox_4 = new fusepump.lightbox.buynow(19450), document.getElementById("lightbox-call-to-action-4").addEventListener("click", function() {
        lightbox_4.show();
    }), lightbox_5 = new fusepump.lightbox.buynow(19449), document.getElementById("lightbox-call-to-action-5").addEventListener("click", function() {
        lightbox_5.show();
    }), lightbox_11 = new fusepump.lightbox.buynow(19452), document.getElementById("lightbox-call-to-action-11").addEventListener("click", function() {
        lightbox_11.show();
    }), lightbox_12 = new fusepump.lightbox.buynow(20183), document.getElementById("lightbox-call-to-action-12").addEventListener("click", function() {
        lightbox_12.show();
    }), lightbox_13 = new fusepump.lightbox.buynow(19453), document.getElementById("lightbox-call-to-action-13").addEventListener("click", function() {
        lightbox_13.show();
    }), lightbox_14 = new fusepump.lightbox.buynow(19450), document.getElementById("lightbox-call-to-action-14").addEventListener("click", function() {
        lightbox_14.show();
    }), lightbox_15 = new fusepump.lightbox.buynow(19449), document.getElementById("lightbox-call-to-action-15").addEventListener("click", function() {
        lightbox_15.show();
    }), e("#lightbox-call-to-action-0, #lightbox-call-to-action-1, #lightbox-call-to-action-2, #lightbox-call-to-action-3, #lightbox-call-to-action-4, #lightbox-call-to-action-5, #lightbox-call-to-action-6").click(function(e) {
        e.preventDefault();
    }), e("#lightbox-call-to-action-20, #lightbox-call-to-action-11, #lightbox-call-to-action-12, #lightbox-call-to-action-13, #lightbox-call-to-action-14, #lightbox-call-to-action-15, #lightbox-call-to-action-16, #lightbox-call-to-action-20").click(function(e) {
        e.preventDefault();
    });
});
...
raf ? raf(function() {
    ...
    $(".slick-arrow-right").click(), $(".slick-arrow-right").click(), $("#main-slider .slider").css("height", "500px"), 
    $("#main-slider .slider .slide.slick-slide").css("width", "100vw!important"), setTimeout(function() {
