!function(a, b) {
    ...
    r.ajaxSetup({
        ...
        offset: function(a) {
            ...
            return f ? f.getClientRects().length ? (d = f.getBoundingClientRect()).width || d.height ? (e = f.ownerDocument, 
    ...
    jQuery(document).ready(function(i) {
        !function(i) {
            var e = navigator.userAgent.toLowerCase(), o = function(i) {
                return e.indexOf(i) > -1;
            }, s = "gecko", t = "webkit", l = "safari", n = "opera", d = "mobile", h = document.documentElement, w = [ !/opera|webtv/i.test(e) && /msie\s(\d)/.test(e) ? "ie ie" + RegExp.$1 : o("firefox/2") ? s + " ff2" : o("firefox/3.5") ? s + " ff3 ff3_5" : o("firefox/3.6") ? s + " ff3 ff3_6" : o("firefox/3") ? s + " ff3" : o("gecko/") ? s : o("opera") ? n + (/version\/(\d+)/.test(e) ? " " + n + RegExp.$1 : /opera(\s|\/)(\d+)/.test(e) ? " " + n + RegExp.$2 : "") : o("konqueror") ? "konqueror" : o("blackberry") ? d + " blackberry" : o("android") ? d + " android" : o("chrome") ? t + " chrome" : o("iron") ? t + " iron" : o("applewebkit/") ? t + " " + l + (/version\/(\d+)/.test(e) ? " " + l + RegExp.$1 : "") : o("mozilla/") ? s : "", o("j2me") ? d + " j2me" : o("iphone") ? d + " iphone" : o("ipod") ? d + " ipod" : o("ipad") ? d + " ipad" : o("mac") ? "mac" : o("darwin") ? "mac" : o("webtv") ? "webtv" : o("win") ? "win" + (o("windows nt 6.0") ? " vista" : "") : o("freebsd") ? "freebsd" : o("x11") || o("linux") ? "linux" : "", "js" ];
            c = w.join(" "), h.className += " " + c;
        }(), i(window).width() > 770 ? i(".no-flexbox .wk-cols").each(function() {
            items = i(this).children(".wk-col").length, width = 100 / items, i(this).children(".wk-col").css("width", width + "%");
        }) : i(".no-flexbox .wk-cols").each(function() {
            i(this).children(".wk-col").css("width", "100%");
        }), i(".no-flexbox .wk-cols-m").each(function() {
            items = i(this).children('[class~="wk-col"]').length, width = 100 / items, i(this).children('[class~="wk-col"]').css("width", width + "%");
        }), i(window).width() > 415 ? i(".no-flexbox .wk-cols-t").each(function() {
            items = i(this).children('[class~="wk-col"]').length, width = 100 / items, i(this).children('[class^="wk-col"]').css("width", width + "%");
        }) : i(".no-flexbox .wk-cols-t").each(function() {
            i(this).children('[class~="wk-col"]').css("width", "100%");
            ...
            i(window).scrollTop() >= 10 ? i("body").addClass("is-scrolled") : i("body").removeClass("is-scrolled");
        }), i(window).on("resize", function() {
            i(this).width() < 770 ? (i("html").addClass("mobile"), i("html").removeClass("desktop")) : (i("html").removeClass("mobile"), 
            i("html").addClass("desktop"));
        }), i(window).width() < 770 && i("html").addClass("mobile"), i(window).width() > 771 && i("html").addClass("desktop");
    });
    ...
    function i(t) {
        ...
        t.preventDefault(), r && r.current.opts.$orig.is(e) || (a ? (i = i.length ? i.filter('[data-fancybox="' + a + '"]') : n('[data-fancybox="' + a + '"]'), 
        (s = i.index(e)) < 0 && (s = 0)) : i = [ e ], n.fancybox.open(i, o, s));
    }
    if (n) {
        ...
        n.extend(h.prototype, {
            ...
            createGroup: function(t) {
                ...
                n.each(i, function(t, i) {
                    ...
                    l.opts.caption = l.opts.caption === o ? "" : l.opts.caption + "", "ajax" === s && (c = r.split(/\s+/, 2)).length > 1 && (l.src = c.shift(), 
                    l.opts.filter = c.shift()), "auto" == l.opts.smallBtn && (n.inArray(s, [ "html", "inline", "ajax" ]) > -1 ? (l.opts.toolbar = !1, 
            ...
            scaleToActual: function(t, e, i) {
                ...
                c = g / a.width, l = b / a.height, s = .5 * h - .5 * g, r = .5 * p - .5 * b, g > h && ((s = a.left * c - (t * c - t)) > 0 && (s = 0), 
                s < h - g && (s = h - g)), b > p && ((r = a.top * l - (e * l - e)) > 0 && (r = 0), 
                r < p - b && (r = p - b)), u.updateCursor(g, b), n.fancybox.animate(f, {
                    top: r,
                    left: s,
                    scaleX: c,
                    scaleY: l
            ...
            updateCursor: function(t, e) {
                var i = this, a = i.$refs.container.removeClass("fancybox-is-zoomable fancybox-can-zoomIn fancybox-can-drag fancybox-can-zoomOut");
                i.current && !i.isClosing && (i.isZoomable() ? (a.addClass("fancybox-is-zoomable"), 
                (t !== o && e !== o ? t < i.current.width && e < i.current.height : i.isScaledDown()) ? a.addClass("fancybox-can-zoomIn") : i.current.opts.touch ? a.addClass("fancybox-can-drag") : a.addClass("fancybox-can-zoomOut")) : i.current.opts.touch && a.addClass("fancybox-can-drag"));
            },
            isZoomable: function() {
            ...
            isScaledDown: function() {
                var e = this.current, o = e.$content, i = !1;
            ...
            setIframe: function(t) {
                ...
                a.preload ? (i.showLoading(t), e.on("load.fb error.fb", function(e) {
                    ...
                    var n, s, r = t.$content, c = a.css.width, l = a.css.height;
                    if (1 === e[0].isReady) {
                        try {
            ...
            setContent: function(t, e) {
                ...
                t.opts.filter && (e = n("<div>").html(e).find(t.opts.filter))), t.$slide.one("onReset", function() {
                    ...
                    t.isLoaded = !1);
                }), t.$content = n(e).appendTo(t.$slide), t.opts.smallBtn && !t.$smallBtn && (t.$smallBtn = n(o.translate(t, t.opts.btnTpl.smallBtn)).appendTo(t.$content.filter("div").first())), 
                this.afterLoad(t));
            },
            setError: function(t) {
            ...
            revealContent: function(t) {
                ...
                delete r.width, delete r.height, "auto" == (s = t.opts.zoomOpacity) && (s = Math.abs(t.width / t.height - u.width / u.height) > .1), 
            ...
            getThumbPos: function(o) {
                var i, a = this, s = !1, c = o.opts.$thumb, l = c ? c.offset() : 0;
                return l && c[0].ownerDocument === e && function(e) {
                    for (var i = e[0], a = i.getBoundingClientRect(), s = []; null !== i.parentElement; ) "hidden" !== n(i.parentElement).css("overflow") && "auto" !== n(i.parentElement).css("overflow") || s.push(i.parentElement.getBoundingClientRect()), 
                    i = i.parentElement;
            ...
            close: function(t, e) {
                ...
                r.height = r.height * r.scaleY, "auto" == (s = f.opts.zoomOpacity) && (s = Math.abs(f.width / f.height - c.width / c.height) > .1), 
            ...
            cleanUp: function(t) {
                ...
                o.$lastFocus && o.current.opts.backFocus && o.$lastFocus.focus(), o.current = null, 
                (e = n.fancybox.getInstance()) ? e.activate() : (s.scrollTop(o.scrollTop).scrollLeft(o.scrollLeft), 
            ...
            animate: function(t, e, i, a, s) {
                ...
                t.on(r, function(i) {
                    ...
                    e.scaleX = 1, e.scaleY = 1, n.fancybox.setTranslate(t, e)) : !0 !== s && t.removeClass(e), 
                    n.isFunction(a) && a(i));
            ...
            i.type || (a = t.extend(!0, {}, n, i.opts.media), t.each(a, function(n, o) {
                if (r = f.match(o.matcher), u = {}, d = n, r) {
                    if (h = o.type, o.paramPlace && r[o.paramPlace]) {
                        "?" == (l = r[o.paramPlace])[0] && (l = l.substring(1)), l = l.split("&");
    ...
    u.prototype.destroy = function() {
        ...
        i.startPoints && !(i.startPoints.length > 1 && u.isSliding))) {
            ...
            !u.current.opts.touch && !u.canPan() || !c.is(i.$stage) && !i.$stage.find(c).length) return void (c.is("img") && o.preventDefault());
            o.stopPropagation(), n.fancybox.isMobile && (l(i.$target) || l(i.$target.parent())) || o.preventDefault(), 
        ...
        e = s.contentStartPos.top + s.distanceY, (a = s.limitMovement(t, e, s.contentStartPos.width, s.contentStartPos.height)).scaleX = s.contentStartPos.scaleX, 
        a.scaleY = s.contentStartPos.scaleY, s.contentLastPos = a, s.requestId && (i(s.requestId), 
        s.requestId = null), s.requestId = o(function() {
    ...
    if (n) {
        ...
        e(t).on({
            ...
            t.isAnimating = !1, t.update(!0, !0, 0)), t.trigger("onFullscreenChange", o.isFullscreen());
        });
    ...
    e.extend(n.prototype, {
        ...
        "beforeShow.fb": function(t, e, n, o) {
            ...
            if (i && i.isActive) {
                ...
                o && !0 === n.opts.thumbs.autoStart && i.show(), i.isVisible && i.focus();
            }
        },
        "afterKeydown.fb": function(t, e, n, o, i) {
            var a = e && e.Thumbs;
...
}(document, window, window.jQuery), function(a) {
    "use strict";
    ...
    (b = function() {
        ...
        var b, a = this;
        a.options.rows > 1 && ((b = a.$slides.children().children()).removeAttr("style"), 
        ...
        f <= b.slideCount && f++)), g(b.$slider.find(".slick-slide").slice(e, f)), b.slideCount <= b.options.slidesToShow ? (d = b.$slider.find(".slick-slide"), 
        ...
        (j = j.slick("getSlick")).slideCount <= j.options.slidesToShow && j.setSlideClasses(i.currentSlide)), 
        ...
        c = Math.atan2(b, a), 0 > (d = Math.round(180 * c / Math.PI)) && (d = 360 - Math.abs(d)), 
    ...
    !function(e, t, n) {
        ...
        function u(e, t, n) {
            var s;
            for (var o in e) if (e[o] in t) return !1 === n ? e[o] : (s = t[e[o]], r(s, "function") ? f(s, n || t) : s);
            return !1;
        }
        function d(e) {
        ...
        function p(t, n, r) {
            ...
            if ("getComputedStyle" in e) {
                ...
                var o = e.console;
                null !== s ? r && (s = s.getPropertyValue(r)) : o && o[o.error ? "error" : "log"].call(o, "getComputedStyle returning null, its possible modernizr test results are inaccurate");
        ...
        function m(e, n, r, s) {
            var o, l, a, f, u = "modernizr", d = i("div"), p = c();
            if (parseInt(r, 10)) for (;r--; ) a = i("div"), a.id = s ? s[r] : u + (r + 1), d.appendChild(a);
            ...
            d.id = u, p.fake && (p.style.background = "", p.style.overflow = "hidden", f = w.style.overflow, 
        ...
        function v(e, t, s, o) {
            ...
            for (var d, p, c, m, v, y = [ "modernizr", "tspan", "samp" ]; !j.style && y.length; ) d = !0, 
            j.modElem = i(y.shift()), j.style = j.modElem.style;
            for (c = e.length, p = 0; c > p; p++) if (m = e[p], v = j.style[m], l(m, "-") && (m = a(m)), 
            j.style[m] !== n) {
                if (o || r(s, "undefined")) return f(), "pfx" != t || m;
                try {
                    j.style[m] = s;
                } catch (h) {}
                if (j.style[m] != v) return f(), "pfx" != t || m;
            }
            return f(), !1;
        }
        function y(e, t, n, s, o) {
            var i = e.charAt(0).toUpperCase() + e.slice(1), l = (e + " " + k.join(i + " ") + i).split(" ");
            return r(t, "string") || r(t, "undefined") ? v(l, t, s, o) : (l = (e + " " + E.join(i + " ") + i).split(" "), 
            u(l, t, n));
        }
        function h(e, t, r) {
            return y(e, n, n, t, r);
        ...
        var w = t.documentElement, b = "svg" === w.nodeName.toLowerCase(), _ = S._config.usePrefixes ? " -webkit- -moz- -o- -ms- ".split(" ") : [ "", "" ];
        S._prefixes = _, Modernizr.addTest("cssgradients", function() {
            for (var e, t = "background-image:", r = "", s = 0, o = _.length - 1; o > s; s++) e = 0 === s ? "to " : "", 
        ...
        var P = "CSS" in e && "supports" in e.CSS, T = "supportsCSS" in e;
        Modernizr.addTest("supports", P || T);
        var z = "Moz O ms Webkit", k = S._config.usePrefixes ? z.split(" ") : [];
        S._cssomPrefixes = k;
        ...
        Modernizr._q.unshift(function() {
            delete j.style;
        }), S.testAllProps = y, S.testAllProps = h, Modernizr.addTest("cssfilters", function() {
        ...
        }), Modernizr.addTest("flexbox", h("flexBasis", "1px", !0)), function() {
            var e, t, n, s, o, i, l;
            for (var a in x) if (x.hasOwnProperty(a)) {
                if (e = [], (t = x[a]).name && (e.push(t.name.toLowerCase()), t.options && t.options.aliases && t.options.aliases.length)) for (n = 0; n < t.options.aliases.length; n++) e.push(t.options.aliases[n].toLowerCase());
                for (s = r(t.fn, "function") ? t.fn() : t.fn, o = 0; o < e.length; o++) i = e[o], 
                1 === (l = i.split(".")).length ? Modernizr[l[0]] = s : (!Modernizr[l[0]] || Modernizr[l[0]] instanceof Boolean || (Modernizr[l[0]] = new Boolean(Modernizr[l[0]])), 
                Modernizr[l[0]][l[1]] = s), C.push((s ? "" : "no-") + l.join("-"));
            }
        }(), function(e) {
    ...
    if (-1 == userAgent.indexOf("Speed Insights") && -1 == userAgent.indexOf("PTST")) {
        var x = document.createElement("script"), t = document.createTextNode("\t\t(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':\t new Date().getTime(),event:'gtm.js'});var f=d.getElementsByTagName(s)[0],\t j=d.createElement(s),dl=l!='dataLayer'?'&l='+l:'';j.async=true;j.src=\t \t'https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f); \t\t})(window,document,'script','dataLayer','GTM-NBJJC6');\t\t");
        x.appendChild(t), document.head.appendChild(x);
        var link = document.createElement("link");
        link.rel = "stylesheet", link.href = "https://fonts.googleapis.com/css?family=Open+Sans:300,400,700,800", 
    ...
    $(".slider").slick({
        ...
        $(this).width() < 770 || $("body").removeClass("off-canvas-is-active");
...
var loadDeferredStyles = function() {
    ...
    replacement.innerHTML = addStylesNode.textContent, replacement.firstChild.onload = function() {
        $(".wk-preloading").fadeOut("slow"), $(".slider").slick("refresh");
